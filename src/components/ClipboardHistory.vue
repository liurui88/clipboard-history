  ...
  <div class="h-screen flex flex-col bg-gradient-to-b from-primary to-[#16161a]">
    <header class="flex items-center justify-between px-4 py-3.5 bg-secondary border-b border-border select-none">
      ...
      <div class="flex gap-1.5">
        <button
          @click="openSettings"
          title="设置"
          class="flex items-center justify-center w-7 h-7 rounded-md bg-transparent text-text-secondary hover:bg-hover hover:text-text-primary transition-all duration-150"
        >
    ...
    <div class="flex-1 relative overflow-hidden">
      ...
      <button
        v-if="showScrollTop"
        @click="scrollToTop"
        class="absolute bottom-4 right-4 z-50 w-10 h-10 rounded-full bg-accent text-white shadow-lg hover:bg-accent/90 transition-all duration-200 flex items-center justify-center"
        title="滚动到顶部"
      >
